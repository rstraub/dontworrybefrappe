...
func init() {
	proto.RegisterType((*PingMessage)(nil), "frappe_api.PingMessage")
}
...
var fileDescriptor_076e6b8e4df60c46 = []byte{
	...
	0xc4, 0x27, 0x16, 0x64, 0x2a, 0x69, 0x72, 0x71, 0x07, 0x64, 0xe6, 0xa5, 0xfb, 0xa6, 0x16, 0x17,
	0x27, 0xa6, 0xa7, 0x0a, 0x49, 0x71, 0x71, 0xa4, 0x17, 0xa5, 0xa6, 0x96, 0x64, 0xe6, 0xa5, 0x4b,
	0x30, 0x2a, 0x30, 0x6a, 0x70, 0x06, 0xc1, 0xf9, 0x46, 0x6e, 0x5c, 0x2c, 0x20, 0xa5, 0x42, 0x76,
	0x5c, 0x1c, 0xc1, 0x89, 0x95, 0x1e, 0xa9, 0x39, 0x39, 0xf9, 0x42, 0xe2, 0x7a, 0x08, 0xb3, 0xf4,
	0x90, 0x0c, 0x92, 0xc2, 0x25, 0xa1, 0xc4, 0x90, 0xc4, 0x06, 0x76, 0x85, 0x31, 0x20, 0x00, 0x00,
	0xff, 0xff, 0x16, 0x92, 0xb9, 0x76, 0x99, 0x00, 0x00, 0x00,
}
...
func (c *pingClient) SayHello(ctx context.Context, in *PingMessage, opts ...grpc.CallOption) (*PingMessage, error) {
	out := new(PingMessage)
	err := c.cc.Invoke(ctx, "/frappe_api.Ping/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Ping_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/frappe_api.Ping/SayHello",
	}
